# USAGE
# python predict_url.py --model fashion_multitask_learning.h5 --labelbin mlb.pkl --image 'https://keimag.com.my/image/cache/cache/4001-5000/4432/main/3163-DSC_0557-2c-0-1-0-1-1-800x1200.jpg'
...
def _predict_image(image, model, mlb):
  ...
  # plt.imshow(output)
  # cv2.imwrite('predict_url.jpg', output)
